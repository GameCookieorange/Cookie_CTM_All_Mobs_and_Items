...
execute if score @s light_gray_timer matches 2 run function light_gray:mob/zombie_elite/machine/calculate_motion_jump_right

execute unless block ~ ~-0.5 ~ air run function light_gray:mob/zombie_elite/machine/ground_impact
