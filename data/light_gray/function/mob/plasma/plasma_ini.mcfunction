...
execute as @e[type=shulker_bullet, tag=!player_item, distance=..5] at @s run execute if entity @e[tag=light_gray.plasma, distance=..3] run function light_gray:mob/plasma/bullet
