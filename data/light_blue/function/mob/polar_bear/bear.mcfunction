...
# /give @p spawner[block_entity_data={id:"mob_spawner",SpawnCount:2,SpawnRange:2,MaxNearbyEntities:10,RequiredPlayerRange:16,Delay:1,MinSpawnDelay:800,MaxSpawnDelay:1000,SpawnPotentials:[{data:{custom_spawn_rules:{sky_light_limit:{min_inclusive:0,max_inclusive:15},block_light_limit:{min_inclusive:0,max_inclusive:15}},entity:{id:"minecraft:polar_bear",Team:"light_blue_ice_creature",Health:26f,Age:2,Tags:["light_blue.polar_bear"],CustomName:{"bold":true,"color":"#75DAE6","italic":false,"shadow_color":-14064897,"text":"發怒北極熊","underlined":true},attributes:[{id:"minecraft:max_health",base:26},{id:"minecraft:movement_speed",base:0.3},{id:"minecraft:scale",base:1.2}]}},weight:1}]}] 1
