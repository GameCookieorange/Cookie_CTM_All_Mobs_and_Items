...
execute as @e[distance=..8, type=!#minecraft:not_mob, tag=!brown.steam_supply_item] at @s run damage @s 11 player_explosion by @e[limit=1, type=slime, distance=..10, tag=brown.steam_supply_item]
kill @s