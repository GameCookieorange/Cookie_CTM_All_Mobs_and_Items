...
execute as @e[tag=!brown.steampunk, distance=..3, type=!#minecraft:not_mob] run damage @s 16 mob_attack by @e[limit=1, sort=nearest, tag=brown.saboteur, type=piglin_brute] from @e[limit=1, sort=nearest, tag=brown.saboteur, type=piglin_brute]