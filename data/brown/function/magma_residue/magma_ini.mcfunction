...
execute if score @s brown_timer matches 300 at @s run team leave @s
execute if score @s brown_timer matches 320 at @s run team join brown_steampunk @s
execute if score @s brown_timer matches 340 at @s run team leave @s
execute if score @s brown_timer matches 360 at @s run team join brown_steampunk @s
execute if score @s brown_timer matches 370 at @s run team leave @s
execute if score @s brown_timer matches 380 at @s run team join brown_steampunk @s
execute if score @s brown_timer matches 390 at @s run team leave @s
execute if score @s brown_timer matches 400.. at @s run function brown:magma_residue/explode

# /give @p spawner[block_entity_data={id:"mob_spawner",SpawnCount:3,SpawnRange:5,MaxNearbyEntities:5,RequiredPlayerRange:14,Delay:0,MinSpawnDelay:2000,MaxSpawnDelay:2600,SpawnPotentials:[{data:{custom_spawn_rules:{sky_light_limit:{min_inclusive:0,max_inclusive:15},block_light_limit:{min_inclusive:0,max_inclusive:15}},entity:{id:"minecraft:magma_cube",Team:"brown_steampunk",Health:20f,Size:1,wasOnGround:1b,Tags:["brown.magma_residue","brown.steampunk"],Passengers:[{id:"minecraft:marker",Tags:["brown.lava_marker"]}],CustomName:{"bold":true,"color":"#B36427","italic":false,"shadow_color":-46820,"translate":"熔岩殘渣","underlined":true},attributes:[{id:"minecraft:jump_strength",base:0.5},{id:"minecraft:movement_speed",base:0.8},{id:"minecraft:max_health",base:20},{id:"minecraft:scale",base:1.6},{id:"minecraft:attack_damage",base:7.5}]}},weight:1}]}] 1