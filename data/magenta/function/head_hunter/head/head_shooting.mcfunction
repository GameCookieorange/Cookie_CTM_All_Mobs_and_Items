...
execute at @s run summon armor_stand ~ ~2 ~ {Silent:1b,Invulnerable:1b,Small:1b,Marker:0b,Invisible:1b,NoBasePlate:1b,Tags:["magenta.mob","magenta.shooting_head"],DisabledSlots:4144959}
