...
# /give @p spawner[block_entity_data={id:"mob_spawner",SpawnCount:1,SpawnRange:5,MaxNearbyEntities:8,RequiredPlayerRange:16,Delay:1,MinSpawnDelay:1400,MaxSpawnDelay:1800,SpawnPotentials:[{data:{custom_spawn_rules:{sky_light_limit:{min_inclusive:0,max_inclusive:15},block_light_limit:{min_inclusive:0,max_inclusive:15}},entity:{id:"minecraft:slime",HurtTime:10,Health:30f,Size:3,PersistenceRequired:1b,wasOnGround:1b,Tags:["magenta.big_slime"],CustomName:{"bold":true,"color":"light_purple","italic":false,"shadow_color":-7348638,"text":"**大史萊姆**","underlined":true},attributes:[{id:"minecraft:attack_damage",base:4},{id:"minecraft:attack_knockback",base:20},{id:"minecraft:jump_strength",base:0},{id:"minecraft:max_health",base:30},{id:"minecraft:scale",base:2.5}]}},weight:1}]}] 1