...
execute if score @s orange_timer matches 80..135 at @s run tp @s ^ ^ ^ ~30 ~

execute if score @s orange_timer matches 60..135 at @s run particle minecraft:cloud ~ ~1 ~ 0.1 0.1 0.1 0.2 1 force

# ========================================

execute if score @s orange_timer matches 60 run effect give @s glowing 4 1 false
execute if score @s orange_timer matches 70 run tag @s add current_center

execute if score @s orange_timer matches 60..140 run particle minecraft:firework ~ ~ ~ 0 3 0 0.01 4

# [Distance: 7-10
execute if score @s orange_timer matches 80..140 at @s as @e[distance=7..10,type=!#minecraft:hostile] at @s facing entity @e[tag=current_center,limit=1,distance=7..10] feet rotated ~ 0 positioned ^ ^ ^0.025 if block ^ ^ ^0.5 #thecookieorange:passable run tp @s ^ ^ ^

# [Distance: 4-7]
execute if score @s orange_timer matches 80..140 at @s as @e[distance=4..7,type=!#minecraft:hostile] at @s facing entity @e[tag=current_center,limit=1,distance=4..7] feet rotated ~ 0 positioned ^ ^ ^0.05 if block ^ ^ ^0.5 #thecookieorange:passable run tp @s ^ ^ ^

# [Distance: 1-4]
execute if score @s orange_timer matches 80..140 at @s as @e[distance=1..4,type=!#minecraft:hostile] at @s facing entity @e[tag=current_center,limit=1,distance=1..4] feet rotated ~ 0 positioned ^ ^ ^0.075 if block ^ ^ ^0.5 #thecookieorange:passable run tp @s ^ ^ ^
...
execute if score @s orange_timer matches 140 run tag @s remove current_center
...
execute if score @s orange_debug matches 1500.. run data merge entity @s {ignited:1b,Fuse:20}

execute if score @s orange_debug matches 1600.. run scoreboard players set @s orange_debug 0 
