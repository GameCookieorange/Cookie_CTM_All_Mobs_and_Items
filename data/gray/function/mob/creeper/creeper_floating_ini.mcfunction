...
execute if score @s gray_timer matches 20..130 run particle flame ~ ~1 ~ 1.5 1.5 1.5 0.02 1 normal

execute if score @s gray_timer matches 20..130 run execute as @a[distance=..4.5] run execute at @s run damage @s 3 minecraft:in_fire

execute if score @s gray_timer matches 75 at @s run effect give @s minecraft:glowing 4 1 true

execute if score @s gray_timer matches 75 at @s run playsound minecraft:entity.breeze.idle_ground hostile @a ~ ~ ~ 0.8 0.9
...
execute if score @s gray_timer matches 70..130 run particle dust_color_transition{from_color:[1.000,0.506,0.220],to_color:[1.000,0.000,0.000],scale:1} ~ ~1 ~ 0.2 2 0.2 2 20
...
execute if score @s gray_timer matches 20 at @s run playsound entity.breeze.idle_ground hostile @a ~ ~ ~ 1 0.6
execute if score @s gray_timer matches 80 at @s run playsound entity.breeze.idle_ground hostile @a ~ ~ ~ 1 0.3
