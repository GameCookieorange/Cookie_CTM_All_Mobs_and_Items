...
# give @p spawner[block_entity_data={id:"mob_spawner",SpawnCount:1,SpawnRange:1,MaxNearbyEntities:1,RequiredPlayerRange:45,Delay:1,MinSpawnDelay:1500,MaxSpawnDelay:1800,SpawnPotentials:[{data:{custom_spawn_rules:{sky_light_limit:{min_inclusive:0,max_inclusive:15},block_light_limit:{min_inclusive:0,max_inclusive:15}},entity:{id:"minecraft:stray",PersistenceRequired:1b,OnGround:1b,Health:30f,Tags:["gray.wind_stray_sniper"],CustomName:{"bold":true,"color":"#c5c5c5","shadow_color":-9857885,"translate":"☁*霧霾狙擊手*☁"},equipment:{chest:{id:"minecraft:netherite_chestplate",count:1,components:{"minecraft:trim":{material:"minecraft:diamond",pattern:"minecraft:eye"},"minecraft:enchantments":{"blast_protection":10}}},head:{id:"minecraft:oxidized_copper_grate",count:1},mainhand:{id:"minecraft:crossbow",count:1},offhand:{id:"minecraft:firework_rocket",count:4, components:{"minecraft:fireworks":{explosions:[{shape:"large_ball",has_twinkle:true,has_trail:true,colors:[I;13092807],fade_colors:[I;8882055]}]}}}},drop_chances:{chest:0.000,head:0.000,mainhand:0.000,offhand:1.000},attributes:[{id:"minecraft:attack_damage",base:6},{id:"minecraft:explosion_knockback_resistance",base:0.9},{id:"minecraft:follow_range",base:46},{id:"minecraft:knockback_resistance",base:0.7},{id:"minecraft:movement_speed",base:0.05},{id:"max_health",base:30}]}},weight:1}]}] 1